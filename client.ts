...
export class AuthClient {
  ...
  protected processExternalLoginCallback(
    response: Response
  ): Promise<FileResponse | null> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processSendConfirmationCode(
    response: Response
  ): Promise<FileResponse | null> {
    const status = response.status;
    let _headers: any = {};
...
export class BasketClient {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : <BasketResponse>JSON.parse(_responseText, this.jsonParseReviver);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  addProduct(
    addAddProductRequest: AddProductRequest,
    signal?: AbortSignal | undefined
  ): Promise<FileResponse | null> {
    let url_ = this.baseUrl + '/v1.0/Basket';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processPatchBasketProduct(
    response: Response
  ): Promise<FileResponse | null> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processDeleteBasketProduct(
    response: Response
  ): Promise<FileResponse | null> {
    const status = response.status;
    let _headers: any = {};
...
export class CafesClient {
  ...
  searchCafes(
    ...
    signal?: AbortSignal | undefined
  ): Promise<SearchResponseOfCafeResponse> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : <CafeResponse>JSON.parse(_responseText, this.jsonParseReviver);
        return result200;
      });
    } else if (status === 404) {
      return response.text().then((_responseText) => {
  ...
  getCafeProducts(
    cafeId: number,
    signal?: AbortSignal | undefined
  ): Promise<SearchResponseOfProductResponse> {
  ...
  protected processGetCafeProducts(
    response: Response
  ): Promise<SearchResponseOfProductResponse> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : <SearchResponseOfProductResponse>(
                JSON.parse(_responseText, this.jsonParseReviver)
              );
        return result200;
      });
  ...
  protected processGetCafeProducts2(
    response: Response
  ): Promise<ProductResponse> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : <ProductResponse>JSON.parse(_responseText, this.jsonParseReviver);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
...
export class OrdersClient {
  ...
  searchOrders(
    ...
    signal?: AbortSignal | undefined
  ): Promise<SearchResponseOfOrderResponse> {
    let url_ = this.baseUrl + '/v1.0/Orders?';
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : <OrderResponse>JSON.parse(_responseText, this.jsonParseReviver);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ''
            ? null
            : <UserResponse>JSON.parse(_responseText, this.jsonParseReviver);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
