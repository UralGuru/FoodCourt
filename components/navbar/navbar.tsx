...
export const Navbar = () => {
    ...
    return (
        <div className={styles.navbar}>
            <div className={cn(styles.navbarItem, activeHomePage)} onClick={LinkHomePage}>
                <MdHome className={styles.icon}/>
                <div>Главная</div>
            </div>
            <div className={cn(styles.navbarItem, activeBasketPage)} onClick={LinkBasketPage}>
                <FaShoppingBasket className={styles.icon} />
                <div>Корзина</div>
            </div>
            <div className={cn(styles.navbarItem, activeSettingsPage)} onClick={LinkSettingsPage}>
                <IoMdSettings className={styles.icon} />
                <div>Настройки</div>
            </div>
            <div className={cn(styles.navbarItem, activeHistoryPage)} onClick={LinkHistoryPage}>
